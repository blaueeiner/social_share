...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    if([@"shareInstagramStory" isEqualToString:call.method]){
        ...
        NSString *stickerPath = call.arguments[@"stickerPath"];
        NSString *mediaPath = call.arguments[@"mediaPath"];
        NSString *mediaType = call.arguments[@"mediaType"];
        ...
        BOOL isFileExist = [fileManager fileExistsAtPath: stickerPath];
        UIImage *stickerImageShare;
        if (isFileExist) {
            //if image exists
            stickerImageShare = [[UIImage alloc] initWithContentsOfFile:stickerPath];
        }
        ...
        if ([[UIApplication sharedApplication] canOpenURL:urlScheme]) {
            ...
            if ( [ stickerPath  length] == 0 ){
                ...
                if([mediaType isEqualToString: MEDIA_TYPE_IMAGE]) {
                    pasteboardItems =  @[@{@"com.instagram.sharedSticker.backgroundImage" : mediaBackgroundShare,
                                           @"com.instagram.sharedSticker.stickerImage" : stickerImageShare,
                                           @"com.instagram.sharedSticker.backgroundTopColor" : backgroundTopColor,
                                           @"com.instagram.sharedSticker.backgroundBottomColor" : backgroundBottomColor,
                                           @"com.instagram.sharedSticker.contentURL" : attributionURL
                    }];
        ...
        NSString* urlTextEscaped = [urlstring stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLHostAllowedCharacterSet]];
        ...
        NSURL * whatsappURL = [NSURL URLWithString:[urlWhats stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLHostAllowedCharacterSet]]];
        ...
        NSURL * telegramURL = [NSURL URLWithString:[urlScheme stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLHostAllowedCharacterSet]]];
