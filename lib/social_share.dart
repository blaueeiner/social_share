...
class SocialShare {
  ...
  static Future<String> shareSms(String message, {required String url, String? trailingText}) async {
    Map<String, dynamic>? args;
  ...
  static Future<bool> shareOptions(String contentText, {required String imagePath}) async {
    Map<String, dynamic> args;
    if (Platform.isIOS) {
